...
import {
  ...
  Repeat, Shuffle, Heart, HeartOff, Volume2, Music2
} from 'lucide-react'
...
export default function Player() {
  ...
  }, [isPlaying, totalSeconds, isRepeat])
      ...
      <div className="h-14 flex items-center px-4 gap-3">
        ...
        <div className="flex items-center gap-1 shrink-0">
          <Button
            variant="ghost"
            size="icon"
            className={cn('h-8 w-8', currentTrack.liked ? 'text-primary' : 'text-muted-foreground hover:text-foreground')}
